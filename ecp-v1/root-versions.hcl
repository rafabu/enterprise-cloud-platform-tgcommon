...
locals {
  ...
  ecp_azure_modules_repo_version = "dev"                                # "v0.5.1-alpha"

  tg_version_automation = "1.1.6"  # pin terragrunt version for pipelines (interactive execution will use the installed version)
