...
provider "alz" {
  ...
  library_references = [
    ...
    {
      custom_url = "file::${replace(get_repo_root(), "\\", "/")}/lib/ecp-lib/platform/alz-artefacts/?archive=false"
    },
...
%{if contains(
  ["ado-mpool", "ado-project", "az-alz-connectivity-virtual-wan", "az-alz-connectivity-hub-spoke", "az-ecp-parent", "az-platform-subscriptions", "devcenter"],
  basename(replace(get_terragrunt_dir(), "\\", "/"))
)}
provider "time" {}
%{endif}
...
%{if contains(
  ["ado-mpool", "az-alz-connectivity-virtual-wan", "az-alz-connectivity-hub-spoke", "az-alz-management-resources", "az-connectivity-management", "az-devcenter"],
  basename(replace(get_terragrunt_dir(), "\\", "/"))
  )}
    azurerm = {
...
%{endif}
%{if contains(
  ["az-launchpad-main", "az-launchpad-network", "az-launchpad-backend"],
  basename(replace(get_terragrunt_dir(), "\\", "/"))
  )}
    azurerm = {
      source  = "hashicorp/azurerm"
...
%{endif}
%{if contains(
  ["az-alz-base", "az-alz-connectivity-virtual-wan", "az-alz-connectivity-hub-spoke", "az-connectivity-management", "az-devcenter", "az-ecp-parent", "ado-mpool", "ado-project"],
  basename(replace(get_terragrunt_dir(), "\\", "/"))
)}
    time = {
